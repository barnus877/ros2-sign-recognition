...
dataset = '..//training_images_sign_recognition'
...
checkpoint_filepath = "..//network_model//model_sign_recognition.best.keras"
...
model.save("..//network_model//model_sign_recognition.keras")
...
plt.legend()
plt.savefig('..//network_model//model_training_sign_recognition')
plt.show()