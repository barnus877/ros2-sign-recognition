...
def main(args=None):
    ...
    i = 0                # Breaks the loop on ctrl+c
    msg.data = f'Hello, world: kaki' # Write the actual string into msg's data field
    node.get_logger().info(f'Publishing: "{msg.data}"')            # Python wait function in seconds
