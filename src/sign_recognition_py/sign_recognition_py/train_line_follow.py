...
dataset = '..//training_images_line_follow'
...
checkpoint_filepath = "..//network_model//model_line_follow.best.keras"
...
model.save("..//network_model//model_line_follow.keras")
...
plt.legend()
plt.savefig('..//network_model//model_training_line_follow')
plt.show()